...
(function (d) {
    ...
    if (jquery_version >= 1.8)
    {
        ...
        function g(a, b, c) {
            ...
            if (d.support.rgba)
                e += "," + (a && b ? parseFloat(a[3] + c * (b[3] - a[3])) : 1);
            e += ")";
            return e
        }
        function f(a) {
            ...
            if (b = /#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/.exec(a))
                ...
                c = [parseInt(b[1]), parseInt(b[2]), parseInt(b[3]), 1];
        ...
        d.each(h, function (a, b) {
            d.Tween.propHooks[b] = {get: function (c) {
        ...
        d.Tween.propHooks.borderColor = {set: function (a) {
                ...
                d.each(b, function (c,
                        e) {
                    if (a.b)
                        a.elem.style[e] = g(a.c[e], a.d, a.a * a.init.interval / a.options.duration);
                    else {
                        a.c = a.c || [];
