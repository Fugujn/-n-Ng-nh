<div class="content-header row">
  <div class="content-header-left col-md-6 col-xs-12 mb-1">
    <h2 class="content-header-title">Thông tin footer</h2>
  </div>
</div>
<form name="frm" method="post" action="index.php?com=footer&act=save" enctype="multipart/form-data" class="form"> 
