...
$d->reset();
$sql = "select * from table_donhang where type = '".$type."' ";
if ($thang123 != '') {
    $sql .= " and thang = '" . $thang123 . "' ";
}
if ($nam != '') {
    $sql .= " and nam = '" . $nam . "' ";
}
                    ...
                    <?php
                        for ($i = 0, $count = count($quanlyorder1); $i < $count; $i++) {?>
                            <tr>
                                ...
                                <td style="width:15%">
                                    <?php if($quanlyorder1[$i]['phuongthuc'] == 'nhan-hang') { ?>
                                        Thanh toán khi nhận  hàng
                                    <?php } elseif($quanlyorder1[$i]['phuongthuc'] == 'noi-dia') { ?>
