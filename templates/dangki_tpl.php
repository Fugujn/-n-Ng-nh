			...
			<form role="form" action="" method="post" enctype="multipart/form-data" name="formdktv" id="formdktv" onsubmit="return check();">
				<div class="form-group clear">
					...
					<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
						<input type="text" class="form-control" name="username" id="username_tv" placeholder="Tên đăng nhập">
						<span id="usernameLoading_tv" style="display: none;"><img src="images/ajax-loader.gif" width="16"></span>
						<span id="usernameResult_tv"></span>
					</div>
				</div>
				<div class="form-group clear">
					...
					<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
						...
						<span id="matkhauLoading_tv" style="display: none;"><img src="images/ajax-loader.gif" width="16"></span>
				...
				<div class="form-group clear">
					...
					<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
						...
						<span id="golaimatkhauLoading_tv" style="display: none;"><img src="images/ajax-loader.gif" width="16"></span>
				...
				<div class="form-group clear">
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<select name="province" id="province" class="input form-control">
							...
							<option value="<?=$v['provinceid']?>" <?php if($v['provinceid']==$item['province']) echo "selected"; ?> ><?=$v['type']?> <?=$v["name"]?></option>
							<?php }?>
						</select>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
